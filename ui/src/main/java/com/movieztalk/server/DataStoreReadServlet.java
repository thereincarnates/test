...
public class DataStoreReadServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      GqlQuery.Builder query = GqlQuery.newBuilder().setQueryString("SELECT * FROM movie");
      ...
      for (EntityResult entityResult : runQueryResponse.getBatch().getEntityResultList()) {
        System.out.println(entityResult.getEntity().getProperty(0));
      }
      ...
      if (lresp.getFoundCount() > 0) {
        ...
        entityBuilder.addProperty(Property.newBuilder().setName("question")
